...
public class ShadowManConvo : MonoBehaviour
{
    ...
    [SerializeField] public TextMeshPro manConvo;
    [SerializeField] public TMP_Text JulieConvo;
    [SerializeField] public TextMeshPro FToTalk;
    [SerializeField] public GameObject continuePanel;
    [SerializeField] public GameObject PlaceToStay;

    public List<string> messagesJulie;
    public List<string> messagesHomme;
    public int currentManMessageIndex = 0;
    public int currentJulieMessageIndex = 0;
    public bool isManSpeaking = false;
    ...
    public void controlConversation(){
